    ...
    <div
        ...
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
            ...
            <div class="mt-5 max-w-3xl text-center mx-auto">
                <p class="text-lg text-neutral-400">Listings is an online Platform connecting employers to freelancers
                    across the word. Take your company online with us</p>
            </div>
                        ...
                        <li class="flex gap-x-3">
                            ...
                            <div class="grow">
                                <span class="text-sm sm:text-base text-neutral-500">
                                    <span class="font-bold">Easy & fast</span> delivery
                                </span>
                            </div>
                        </li>
                        ...
                        <li class="flex gap-x-3">
                            ...
                            <div class="grow">
                                <span class="text-sm sm:text-base text-gray-500 dark:text-neutral-500">
                                    24hrs <span class="font-bold">Customer Support</span>
                                </span>
                            </div>
                        </li>
